...
var (
	...
	// WASM
	ErrWasmNotActivated         = errors.New("wasm runtime is not activated")
	ErrWasmContractNotActivated = errors.New("wasm contract not activated")
	ErrWasmContractNotDeployed  = errors.New("wasm contract not deployed at this address")
	ErrWasmNotImplemented       = errors.New("wasm method not yet implemented")
	ErrWasmHalted               = errors.New("wasm runtime is halted")
	ErrWasmAlreadyHalted        = errors.New("wasm runtime is already halted")
	ErrWasmNotHalted            = errors.New("wasm runtime is not halted")
	ErrWasmChunksExpired        = errors.New("wasm deploy chunks expired (TTL exceeded)")
	ErrWasmExecutionFailed      = errors.New("wasm execution returned a non-zero status")
	ErrWasmHasNonQsrBalance     = errors.New("contract holds non-QSR tokens; sweep or transfer them before revoking")
	ErrWasmContractRevoked      = errors.New("wasm contract has been revoked")
	ErrWasmContractPaused       = errors.New("wasm contract is paused by deployer")
	ErrWasmArgsTooLarge         = errors.New("wasm execute args exceed MaxArgsBytes")
